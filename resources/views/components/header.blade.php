<header class="header">
    ...
    @if(Auth::user())
        <nav class="logged-menu">
            ...
            <a href="{{route('chat', ['activeChat' => 0])}}" class="logged-menu--item"><img class="chat-button" src="https://img.icons8.com/sf-black-filled/250/e68a01/chat-message.png" alt="Chat"/></a>
